    ...
    return (
        <div style={cardStyle}> 
            ...
            <p style={{ margin: '3px 0', fontSize: '0.8rem', color: '#444' }}>
                Próxima Preventiva: <strong>{dataPrevista ? dataPrevista.toLocaleDateString('pt-BR') : 'Não agendada'}</strong>
            </p>
        ...
        <div className="main-content">
            ...
            <div className="filter-container" style={{padding: '15px', backgroundColor: '#fff', borderRadius: '8px', marginBottom: '20px', display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'flex-end'}}>
                ...
                <div style={{display: 'flex', gap: '10px'}}>
                    <button onClick={handleExportPDF} style={{backgroundColor: '#28a745', color: 'white', height: '38px', border: 'none', borderRadius: '4px', cursor: 'pointer'}}>Exportar PDF</button>
                    <button onClick={handleClearFilters} style={{backgroundColor: '#dc3545', color: 'white', height: '38px', border: 'none', borderRadius: '4px', cursor: 'pointer'}}>Limpar Filtros</button>
                </div>
            </div>
