        ...
        <section className="container">
            <div className="form-section">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <label>Matrícula (Login):</label><input name="matricula" value={form.matricula} onChange={handleChange} placeholder="Matrícula" required />
                    <label>Senha:</label>
                    <input
                        name="senha"
                        type="password"
            ...
            <div className="list-section">
                ...
                <div className="table-container">
                    <table>
                        <thead><tr><th>ID</th><th>Nome</th><th>Matrícula</th><th>Perfil</th><th>Ações</th></tr></thead>
                        <tbody>
                            {users.map(user => (
                                <tr key={user.id}>
                                    <td>{user.id}</td>
